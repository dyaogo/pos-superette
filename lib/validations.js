...
export const SaleItemSchema = z.object({
  ...
  total: z.number()
    .optional()
}).passthrough(); // ✅ Accepter tous les champs supplémentaires des items
...
export const SaleSchema = z.object({
  ...
  cashReceived: z.number()
    .nonnegative() // ✅ Permet 0 et les valeurs positives
    .finite()
    .optional()
    .nullable(),
  ...
  // Champs du mode offline
  createdAt: z.string().optional(),
  synced: z.boolean().optional(),
  id: z.union([z.string(), z.number()]).optional()
}).passthrough() // ✅ Accepter tous les champs supplémentaires
.refine(
  (data) => {
